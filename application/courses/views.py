...
def show_my_courses(student_id):
    stmt = text("SELECT Course.name FROM COURSE_STUDENT JOIN COURSE ON Course.id = Course_Student.course_id WHERE student_id = :student_id ").params(student_id=student_id)
